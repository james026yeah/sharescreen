...
int jpegfsc_is_first_pass_succeed (jpege_file_size_control_t   file_size_control);
int jpegfsc_is_state_encoding_or_output (jpege_file_size_control_t   file_size_control);
