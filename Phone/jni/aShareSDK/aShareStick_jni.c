...
#define  JNIDEFINE(fname) Java_com_archermind_ashare_mirror_NativeAshare_##fname
...
void Java_com_archermind_ashare_mirror_NativeAshare_shareScreen(JNIEnv *env, jobject obj, jobject object_cb, jstring remoteHostIp)
{
	env = env;
	obj = obj;
	LOGD("IN %s\n", __func__);
...
void Java_com_archermind_ashare_mirror_NativeAshare_stopShare(JNIEnv *env, jobject obj)
{
	env = env;
	obj = obj;
	LOGD("IN %s\n", __func__);
