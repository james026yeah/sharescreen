...
class ImageFrameItem extends ImageView {
	...
	public ImageFrameItem(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public ImageFrameItem(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		
		mFrame = getResources().getDrawable(R.drawable.photo_border_bg);
