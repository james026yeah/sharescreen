...
public class ImagesItemsDirectory extends Directory {
	
	private ArrayList<ImagesInfo> mFileList;

	
	public ImagesItemsDirectory(String name, ArrayList<ImagesInfo> fileList) {
		super(name);
		mFileList = fileList;
	}

	private boolean updateItemNode(FileItemNode itemNode, File file,ImagesInfo info)
	{
	...
	private boolean updateItemNodeList(FileItemNode newItemNode,ImagesInfo info)
	{
		if (newItemNode == null) {
			return false;
		}
