 ...
 * Original file: /work/aShare/Phone/src/archermind/dlna/mobile/IMusicPlayService.aidl
 */
package archermind.dlna.mobile;
public interface IMusicPlayService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements archermind.dlna.mobile.IMusicPlayService
{
private static final java.lang.String DESCRIPTOR = "archermind.dlna.mobile.IMusicPlayService";
...
/**
 * Cast an IBinder object into an archermind.dlna.mobile.IMusicPlayService interface,
 * generating a proxy if needed.
 */
public static archermind.dlna.mobile.IMusicPlayService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof archermind.dlna.mobile.IMusicPlayService))) {
return ((archermind.dlna.mobile.IMusicPlayService)iin);
}
return new archermind.dlna.mobile.IMusicPlayService.Stub.Proxy(obj);
}
...
java.util.List<archermind.dlna.media.MusicItem> _arg0;
_arg0 = data.createTypedArrayList(archermind.dlna.media.MusicItem.CREATOR);
this.setPlayList(_arg0);
reply.writeNoException();
reply.writeTypedList(_arg0);
return true;
}
case TRANSACTION_playFrom:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
private static class Proxy implements archermind.dlna.mobile.IMusicPlayService
{
...
public void setPlayList(java.util.List<archermind.dlna.media.MusicItem> playlist) throws android.os.RemoteException
{
...
_reply.readTypedList(playlist, archermind.dlna.media.MusicItem.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
public void playFrom(int i) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(i);
mRemote.transact(Stub.TRANSACTION_playFrom, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_playFrom = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
...
static final int TRANSACTION_prev = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_next = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
...
static final int TRANSACTION_openFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_open = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getQueuePosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
