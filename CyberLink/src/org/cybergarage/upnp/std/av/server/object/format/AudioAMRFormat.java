...
public class AudioAMRFormat extends AudioIOFormat
{
	
	private static final String mimeType = "audio/amr";
	public AudioAMRFormat()
	{
	}
	
	public AudioAMRFormat(File file)
	{
		super(file);
	}
	...
	{
		return new AudioAMRFormat(file);
	}
