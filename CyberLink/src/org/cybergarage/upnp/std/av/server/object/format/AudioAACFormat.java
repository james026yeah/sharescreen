...
public class AudioAACFormat extends AudioIOFormat
{
	
	private static final String mimeType = "audio/aac";
	public AudioAACFormat()
	{
	}
	
	public AudioAACFormat(File file)
	{
		super(file);
	}
	...
	{
		return new AudioAACFormat(file);
	}
