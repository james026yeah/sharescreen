...
{
public:
  static bool StartServer(int port, bool nonlocal, struct airplay_callback *cb);
...
private:
  CAirPlayServer(int port, bool nonlocal, struct airplay_callback *cb);
  ...
  public:
    ...
    socklen_t m_addrlen;
    //CCriticalSection m_critSection; TODO:cyher
  ...
  bool m_usePassword;
  bool m_bStop;
  static pthread_mutex_t M_STOP_LOCK;
