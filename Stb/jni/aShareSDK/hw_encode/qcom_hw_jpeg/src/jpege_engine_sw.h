...
10/14/09   sw      Remove IPL, added in-line cropping and upscaling support,
...
struct jpege_engine_sw_t
{
    ...
    int16_t lumaQuantTableQ16[BLOCK_SIZE];
    int16_t chromaQuantTableQ16[BLOCK_SIZE];

    int16_t zigzagOffsetTable[BLOCK_SIZE];
    ...
    int16_t  currMCULumaDctOutput[BLOCK_SIZE * H2V2_NUM_LUMA_BLOCKS];
    int16_t  currMCUChromaDctOutput[BLOCK_SIZE * NUM_CHROMA_BLOCKS];
