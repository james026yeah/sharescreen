...
public class DLNAPlayer extends Activity implements SurfaceHolder.Callback{
        ...
        public void handleMessage(Message msg) {
          switch (msg.what) {
            ...
            case TypeDefs.MSG_DMR_AV_TRANS_SET_VOLUME:
            	setvolume(Float.parseFloat(msg.obj.toString()), Float.parseFloat(msg.obj.toString()));
	...
	public void play(String url)
	{
		if (mMediaType == TypeDefs.MEDIA_TYPE_DLNA_AUDIO) {
			try {
				...
				//mMediaPlayer.setVideoQuality(android.media.MediaPlayer.VIDEOQUALITY_HIGH);
				mMediaPlayer.start();
